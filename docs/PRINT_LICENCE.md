...
This Licence takes effect once the balance of the session fee has been paid in full.
...
- **Sell, license, sublicense, or transfer** the Images (or the right to use them) to any third party.
