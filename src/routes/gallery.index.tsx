              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
                {categories.map((category) => (
                  <Link
                    ...
                    className="group relative overflow-hidden rounded-lg aspect-4/3 bg-gray-100 hover:shadow-xl transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
