...
const copy: Record<string, CategoryCopy> = {
	film: {
		...
		metaDescription:
			"Film photography by Eyes of Forest - medium format and 35mm work shot on Hasselblad, Nikon, and Pentax cameras in Vancouver, Canada.",
	},
	digital: {
		intro:
		...
		metaDescription:
			"Digital photography by Eyes of Forest - everyday scenes and quiet moments captured on a Fuji X100VI in Vancouver, Canada.",
	},
	portraits: {
		intro:
			"Portraits on film and digital - faces, gestures, and the stillness between them.",
		metaDescription:
			"Portrait photography by Eyes of Forest - portraits shot on film and digital in Vancouver, Canada.",
	},
};
...
export function getCategoryCopy(slug: string, name: string): CategoryCopy {
	return (
		copy[slug] || {
			...
			metaDescription: `${name} photography gallery by Eyes of Forest - shot on film and digital in Vancouver, Canada.`,
		}
	);
}
